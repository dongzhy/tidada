...
import com.zhy.tidada.mapper.ScoringResultMapper;
import com.zhy.tidada.model.dto.scroingResult.ScoringResultQueryRequest;
...
import com.zhy.tidada.model.vo.ScoringResultVO;
...
public class ScoringResultServiceImpl extends ServiceImpl<ScoringResultMapper, ScoringResult> implements ScoringResultService {
    ...
    public void validScoringResult(ScoringResult scoringResult, boolean add) {
        ...
        if (StringUtils.isNotBlank(resultName)) {
            ThrowUtils.throwIf(resultName.length() > 128, ErrorCode.PARAMS_ERROR, "结果名称不能为128");
        }
        // 补充校验规则
        if (appId != null) {
