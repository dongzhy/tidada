...
import com.zhy.tidada.model.dto.app.AppAddRequest;
import com.zhy.tidada.model.dto.app.AppEditRequest;
import com.zhy.tidada.model.dto.app.AppQueryRequest;
import com.zhy.tidada.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Boolean> editApp(@RequestBody AppEditRequest appEditRequest, HttpServletRequest request) {
        ...
        app.setUserId(oldApp.getUserId());
        //编辑完 也要重置审核状态
        app.setReviewStatus(ReviewStatusEnum.REVIEWING.getValue());
        // 操作数据库
        boolean result = appService.updateById(app);
