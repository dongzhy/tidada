...
import com.zhy.tidada.model.dto.userAnswer.UserAnswerAddRequest;
import com.zhy.tidada.model.dto.userAnswer.UserAnswerEditRequest;
import com.zhy.tidada.model.dto.userAnswer.UserAnswerQueryRequest;
import com.zhy.tidada.model.dto.userAnswer.UserAnswerUpdateRequest;
...
import com.zhy.tidada.model.enums.ReviewStatusEnum;
import com.zhy.tidada.model.vo.UserAnswerVO;
import com.zhy.tidada.scoring.ScoringStrategyExecutor;
import com.zhy.tidada.service.AppService;
import com.zhy.tidada.service.UserAnswerService;
...
public class UserAnswerController {
    ...
    public BaseResponse<Long> addUserAnswer(@RequestBody UserAnswerAddRequest userAnswerAddRequest, HttpServletRequest request) {
        ...
        if (!Objects.equals(ReviewStatusEnum.getEnumByValue(byId.getReviewStatus()), ReviewStatusEnum.PASS)){
        ...
        try {
            UserAnswer UserAnswerWithResult = scoringStrategyExecutor.doScore(choices, byId);
            UserAnswerWithResult.setId(newUserAnswerId);
            UserAnswerWithResult.setAppId(null);
            userAnswerService.updateById(UserAnswerWithResult);
        } catch (Exception e) {
            throw new BusinessException(ErrorCode.OPERATION_ERROR,"评分模块错误");
        }
